...
the device has to be connect to another computer (i used windows in this case), i dont believe you can get it working through the ethernet port (hasnt worked for me) so i only got it connected through a usb cable. 
